Feature: Watch List API
    ...
    Scenario: Add Tv Show to category
        Given no content with title "The Office" is in the "assistidos" list of the user "Gusta"
    ...
    Scenario: Remove movie not in the category
        Given no content with title "Duna 3" is in the "assistidos" list of the user "Gusta"
